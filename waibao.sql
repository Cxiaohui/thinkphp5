...
CREATE TABLE `hisi_admin_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 系统配置' ROW_FORMAT = Compact;
...
CREATE TABLE `hisi_admin_log`  (
  ...
  `mtime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 80 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 操作日志' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of hisi_admin_log
-- ----------------------------
INSERT INTO `hisi_admin_log` VALUES (44, 1, '系统日志', 'admin/log/index', '{\"page\":\"1\",\"limit\":\"20\"}', '浏览数据', 10, '222.186.190.123', 1534320641, 1534577939);
INSERT INTO `hisi_admin_log` VALUES (45, 1, '数据库管理', 'admin/database/index', '[]', '浏览数据', 4, '222.186.190.123', 1534320647, 1534577940);
INSERT INTO `hisi_admin_log` VALUES (46, 1, '会员等级', 'admin/member/level', '{\"page\":\"1\",\"limit\":\"10\"}', '浏览数据', 24, '222.186.190.123', 1534320652, 1534574452);
INSERT INTO `hisi_admin_log` VALUES (47, 1, '在线升级', 'admin/upgrade/index', '[]', '浏览数据', 2, '222.186.190.123', 1534320721, 1534534304);
INSERT INTO `hisi_admin_log` VALUES (48, 1, '钩子管理', 'admin/hook/index', '{\"page\":\"1\",\"limit\":\"20\"}', '浏览数据', 4, '222.186.190.123', 1534320743, 1534534304);
INSERT INTO `hisi_admin_log` VALUES (49, 1, '插件管理', 'admin/plugins/index', '[]', '浏览数据', 2, '222.186.190.123', 1534320745, 1534534302);
INSERT INTO `hisi_admin_log` VALUES (50, 1, '设计插件', 'admin/plugins/design', '[]', '浏览数据', 1, '192.168.1.174', 1534320750, 1534320750);
INSERT INTO `hisi_admin_log` VALUES (51, 1, '系统管理员', 'admin/user/index', '{\"page\":\"1\",\"limit\":\"20\"}', '浏览数据', 16, '222.186.190.123', 1534320775, 1534577935);
INSERT INTO `hisi_admin_log` VALUES (52, 1, '系统菜单', 'admin/menu/index', '[]', '浏览数据', 68, '222.186.190.123', 1534320781, 1534588929);
INSERT INTO `hisi_admin_log` VALUES (53, 1, '配置管理', 'admin/config/index', '{\"page\":\"1\",\"limit\":\"20\",\"group\":\"sys\"}', '浏览数据', 42, '222.186.190.123', 1534320785, 1534577919);
INSERT INTO `hisi_admin_log` VALUES (54, 1, '系统设置', 'admin/system/index', '[]', '浏览数据', 15, '222.186.190.123', 1534320805, 1534588613);
INSERT INTO `hisi_admin_log` VALUES (55, 1, '系统配置', 'admin/system/index', '{\"group\":\"sys\"}', '浏览数据', 9, '222.186.190.123', 1534320810, 1534588615);
INSERT INTO `hisi_admin_log` VALUES (56, 1, '上传配置', 'admin/system/index', '{\"group\":\"upload\"}', '浏览数据', 1, '192.168.1.174', 1534320830, 1534320830);
INSERT INTO `hisi_admin_log` VALUES (57, 1, '开发配置', 'admin/system/index', '{\"group\":\"develop\"}', '浏览数据', 2, '222.186.190.123', 1534320841, 1534561406);
...
INSERT INTO `hisi_admin_log` VALUES (59, 1, '后台首页', 'admin/index/index', '[]', '浏览数据', 92, '222.186.190.123', 1534330472, 1534588933);
INSERT INTO `hisi_admin_log` VALUES (60, 1, '后台首页', 'admin/index/welcome', '[]', '浏览数据', 67, '222.186.190.123', 1534330473, 1534588933);
INSERT INTO `hisi_admin_log` VALUES (61, 1, '模块管理', 'admin/module/index', '[]', '浏览数据', 10, '222.186.190.123', 1534534300, 1534578291);
INSERT INTO `hisi_admin_log` VALUES (62, 1, '状态设置', 'admin/menu/status', '{\"val\":\"0\",\"table\":\"admin_menu\",\"ids\":\"8\"}', '浏览数据', 3, '222.186.190.123', 1534534363, 1534534380);
INSERT INTO `hisi_admin_log` VALUES (63, 1, '会员列表', 'admin/member/index', '[]', '浏览数据', 1, '222.186.190.123', 1534534399, 1534534399);
INSERT INTO `hisi_admin_log` VALUES (64, 1, '修改菜单', 'admin/menu/edit', '{\"id\":\"211\",\"mod\":\"admin\"}', '浏览数据', 31, '222.186.190.123', 1534534435, 1534588815);
INSERT INTO `hisi_admin_log` VALUES (65, 1, '修改菜单', 'admin/menu/edit', '{\"pid\":\"2\",\"title\":\"\\u5546\\u57ce\\u914d\\u7f6e\",\"icon\":\"aicon ai-shezhi\",\"url\":\"admin\\/payconfig\\/index\",\"param\":\"\",\"status\":\"1\",\"system\":\"1\",\"nav\":\"1\",\"id\":\"211\",\"module\":\"admin\"}', '保存数据', 16, '222.186.190.123', 1534534459, 1534588821);
INSERT INTO `hisi_admin_log` VALUES (66, 1, '用户管理', 'admin/member/index', '[]', '浏览数据', 118, '222.186.190.123', 1534534474, 1534576868);
INSERT INTO `hisi_admin_log` VALUES (67, 1, '修改配置', 'admin/config/edit', '{\"id\":\"39\"}', '浏览数据', 1, '222.186.190.123', 1534561378, 1534561378);
INSERT INTO `hisi_admin_log` VALUES (68, 1, '状态设置', 'admin/member/status', '{\"table\":\"admin_member_level\",\"id\":\"1\",\"val\":\"1\"}', '浏览数据', 2, '222.186.190.123', 1534563176, 1534563181);
INSERT INTO `hisi_admin_log` VALUES (69, 1, '修改会员等级', 'admin/member/editlevel', '{\"id\":\"1\"}', '浏览数据', 2, '222.186.190.123', 1534563226, 1534574888);
INSERT INTO `hisi_admin_log` VALUES (70, 1, '清空缓存', 'admin/index/clear', '[]', '浏览数据', 1, '222.186.190.123', 1534564332, 1534564332);
INSERT INTO `hisi_admin_log` VALUES (71, 1, '添加菜单', 'admin/menu/add', '{\"pid\":\"211\",\"mod\":\"admin\"}', '浏览数据', 11, '222.186.190.123', 1534566985, 1534588842);
INSERT INTO `hisi_admin_log` VALUES (72, 1, '代理管理', 'admin/member/level', '[]', '浏览数据', 31, '222.186.190.123', 1534574610, 1534581898);
INSERT INTO `hisi_admin_log` VALUES (73, 1, '添加菜单', 'admin/menu/add', '{\"pid\":\"211\",\"title\":\"\\u914d\\u7f6e\\u5217\\u8868\",\"icon\":\"typcn typcn-contacts\",\"url\":\"admin\\/payconfig\\/index\",\"param\":\"\",\"status\":\"1\",\"system\":\"0\",\"nav\":\"1\",\"id\":\"\",\"module\":\"admin\"}', '保存数据', 8, '222.186.190.123', 1534577699, 1534588926);
INSERT INTO `hisi_admin_log` VALUES (74, 1, '基础配置', 'admin/system/index', '{\"group\":\"base\"}', '浏览数据', 1, '222.186.190.123', 1534578551, 1534578551);
INSERT INTO `hisi_admin_log` VALUES (75, 1, '排序设置', 'admin/menu/sort', '{\"val\":\"5\",\"table\":\"admin_menu\",\"ids\":\"211\"}', '保存数据', 2, '222.186.190.123', 1534578565, 1534588660);
INSERT INTO `hisi_admin_log` VALUES (76, 1, '公告列表', 'admin/notice/index', '[]', '浏览数据', 50, '222.186.190.123', 1534578839, 1534585967);
INSERT INTO `hisi_admin_log` VALUES (77, 1, '添加公告', 'admin/notice/add', '{\"NewsID\":\"4\"}', '浏览数据', 30, '222.186.190.123', 1534581071, 1534585972);
INSERT INTO `hisi_admin_log` VALUES (78, 1, '添加公告', 'admin/notice/add', '{\"PopID\":\"1\",\"Subject\":\"111\",\"Body\":\"6666\",\"NewsID\":\"4\"}', '保存数据', 12, '222.186.190.123', 1534582153, 1534585979);
INSERT INTO `hisi_admin_log` VALUES (79, 1, '删除公告', 'admin/notice/dellevel', '{\"NewsID\":\"4\"}', '浏览数据', 1, '222.186.190.123', 1534585564, 1534585564);
...
CREATE TABLE `hisi_admin_menu`  (
  ...
  `ctime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 213 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '[系统] 管理菜单' ROW_FORMAT = Compact;
...
INSERT INTO `hisi_admin_menu` VALUES (7, 0, 2, 'admin', '玩家管理', 'aicon ai-huiyuanliebiao', 'admin/member', '', '_self', 2, 0, 1, 1, 1, 1490315067);
INSERT INTO `hisi_admin_menu` VALUES (8, 0, 2, 'admin', '系统扩展', 'aicon ai-shezhi', 'admin/extend', '', '_self', 3, 0, 1, 1, 0, 1490315067);
...
INSERT INTO `hisi_admin_menu` VALUES (18, 0, 8, 'admin', '插件管理', 'aicon ai-chajianguanli', 'admin/plugins/index', '', '_self', 2, 0, 1, 1, 0, 1490315067);
INSERT INTO `hisi_admin_menu` VALUES (19, 0, 8, 'admin', '钩子管理', 'aicon ai-icon-test', 'admin/hook/index', '', '_self', 3, 0, 1, 1, 0, 1490315067);
INSERT INTO `hisi_admin_menu` VALUES (20, 0, 7, 'admin', '代理管理', 'aicon ai-huiyuandengji', 'admin/member/level', '', '_self', 1, 0, 1, 1, 1, 1490315067);
INSERT INTO `hisi_admin_menu` VALUES (21, 0, 7, 'admin', '用户管理', 'aicon ai-huiyuanliebiao', 'admin/member/index', '', '_self', 2, 0, 1, 1, 1, 1490315067);
...
INSERT INTO `hisi_admin_menu` VALUES (206, 0, 2, 'admin', '公告管理', 'aicon ai-tubiao05', 'admin/notice', '', '_self', 5, 0, 0, 1, 1, 1534578276);
INSERT INTO `hisi_admin_menu` VALUES (207, 0, 206, 'admin', '公告列表', 'aicon ai-huiyuanliebiao', 'admin/notice/index', '', '_self', 0, 0, 1, 1, 1, 1534578697);
INSERT INTO `hisi_admin_menu` VALUES (208, 0, 207, 'admin', '添加公告', '', 'admin/notice/add', '', '_self', 0, 0, 1, 1, 1, 1534580652);
INSERT INTO `hisi_admin_menu` VALUES (209, 0, 207, 'admin', '编辑公告', 'aicon ai-caidan', 'admin/member/editlevel', '', '_self', 0, 0, 0, 1, 1, 1534580722);
INSERT INTO `hisi_admin_menu` VALUES (210, 0, 207, 'admin', '删除公告', 'aicon ai-jinyong', 'admin/notice/dellevel', '', '_self', 0, 0, 0, 1, 1, 1534580875);
INSERT INTO `hisi_admin_menu` VALUES (211, 0, 2, 'admin', '商城配置', 'aicon ai-shezhi', 'admin/payconfig/index', '', '_self', 5, 0, 1, 1, 1, 1534588546);
INSERT INTO `hisi_admin_menu` VALUES (212, 0, 211, 'admin', '配置列表', 'typcn typcn-contacts', 'admin/payconfig/index', '', '_self', 0, 0, 0, 1, 1, 1534588926);
...
CREATE TABLE `hisi_admin_user`  (
  ...
  `theme` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '主题',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态',
...
-- ----------------------------
INSERT INTO `hisi_admin_user` VALUES (1, 1, 'admin', '$2y$10$sfyAzVYV/EXRt6bUZOg5huFLyCkyMGygK/3hU4OrpwYuCXkMieVe2', '超级管理员', '', '', '', 1, '0', 1, '222.186.190.123', 1534562847, 1534242250, 1534562847);
