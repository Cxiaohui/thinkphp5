...
<head>
    ...
    <title>API在线文档</title>
    <link href="__ADMIN_SOURCE__/api.css" rel="stylesheet" type="text/css" />

    <script language="javascript" src="__ADMIN_SOURCE__/jquery.min.js"></script>
    <script language="javascript" src="__ADMIN_SOURCE__/jquery.dimensions.js"></script>
</head>
<body>
<div class="tit">
    <div id="titcont">
...
<div id="cont">
    <div class='fun'>
        ...
        <form action="{:url('index/api/login')}" method="post">
        ...
        <form action="{:url('index/api/register')}" method="post">
        ...
        <form action="{:url('index/api/sms')}" method="post">
        ...
        <form action="{:url('index/api/userInfo')}" method="post">
