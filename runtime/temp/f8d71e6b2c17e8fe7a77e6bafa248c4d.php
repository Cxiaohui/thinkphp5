<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"C:\xampp\htdocs\LotusAdmin/app/index\view\index\index.php";i:1534311166;}*/ ?>

<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>API在线文档</title>
    <link href="/static/admin/source/api.css" rel="stylesheet" type="text/css" />

    <script language="javascript" src="/static/admin/source/jquery.min.js"></script>
    <script language="javascript" src="/static/admin/source/jquery.dimensions.js"></script>
</head>
<body>
<div class="tit">
    <div id="titcont">
