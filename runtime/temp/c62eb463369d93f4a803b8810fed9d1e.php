...
<div class="page-form">
    <fieldset class="layui-elem-field layui-field-title">
      <legend>卸载模块：<?php echo $data_info['title']; ?>[<?php echo $data_info['name']; ?>]</legend>
    </fieldset>
