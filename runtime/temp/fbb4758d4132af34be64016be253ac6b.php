...
<form id="pageListForm">
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                <td class="font12"><?php echo $vo['OnLineID']; ?></td>
                <td class="font12"><?php echo getUserNikname($vo['GameID'],'GameID'); ?></td>
                <td class="font12"><?php echo $vo['GameID']; ?></td>
                <td class="font12"><?php echo $vo['OrderID']; ?></td>
                <td class="font12"><?php echo $vo['OrderAmount']; ?></td>
                <td class="font12"><?php echo $vo['PayAmount']; ?></td>
                <td class="font12"><?php echo $vo['RoomCard']; ?></td>
                <td class="font12"><?php echo $vo['ApplyDate']; ?></td>
