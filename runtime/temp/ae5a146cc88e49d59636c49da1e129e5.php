...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="Subject" lay-verify="required" autocomplete="off" value="<?php echo !empty($ret)?$ret['Subject']:''; ?>">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="">
            <textarea cols="200" rows="" id="textarea2" name="Body" value=""><?php echo !empty($ret)?$ret['Body']:''; ?></textarea>
        </div>
    </div>
    <input type="hidden" name="NewsID" value="<?php echo !empty($ret)?$ret['NewsID']:''; ?>"/>
    <div class="layui-form-item">
