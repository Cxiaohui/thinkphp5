        ...
        <form class="layui-form layui-form-pane" action="<?php echo url(); ?>" method="get">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="q" value="<?php echo input('get.q'); ?>" lay-verify="required" placeholder="GamaID,手机、昵称" autocomplete="off" class="layui-input">
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="layui-form">
            <table class="layui-table mt10" lay-even="" lay-skin="row">
                ...
                <tr>
                    ...
                    <td class="font12"><?php echo getUserNikname($vo['UserID']); ?></td>
                    <td class="font12"><?php echo getSpreaderIDUserGameID($vo['UserID']); ?></td>

                    <td class="font12"><?php echo $vo['CollectDate']; ?></td>
