...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="Amount" lay-verify="required" autocomplete="off" value="<?php echo !empty($ret)?$ret['Amount']:''; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">房卡数</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="RoomCard" lay-verify="required" autocomplete="off" value="<?php echo !empty($ret)?$ret['RoomCard']:''; ?>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <?php if($hav_ret){?>
                  <input type="text" class="layui-input field-username" name="GivingProportion" lay-verify="required" autocomplete="off" value="<?php echo !empty($hav_ret)?$hav_ret['GivingProportion']:''; ?>">
            <?php }else{?>
                  <input type="text" class="layui-input field-username" name="GivingProportion" lay-verify="required" autocomplete="off" value="<?php echo !empty($ret)?$ret['GivingProportion']:''; ?>">
            <?php } ?>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <?php if($hav_ret){?>
                   <input type="text" class="layui-input field-username" name="Commission" lay-verify="required" autocomplete="off" value="<?php echo !empty($hav_ret)?$hav_ret['Commission']:''; ?>">
            <?php }else{?>
                 <input type="text" class="layui-input field-username" name="Commission" lay-verify="required" autocomplete="off" value="<?php echo !empty($ret)?$ret->Commission:''; ?>">
            <?php } ?>
        </div>
    </div>

    <input type="hidden" name="ID" value="<?php echo !empty($ret)?$ret['ID']:''; ?>"/>
    <div class="layui-form-item">
