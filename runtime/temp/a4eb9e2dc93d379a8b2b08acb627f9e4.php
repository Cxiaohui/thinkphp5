    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td class="font12"><?php echo $vo['Amount']; ?></td>
                <td class="font12"><?php echo $vo['RoomCard']; ?></td>
                <td class="font12"><?php echo $vo['GivingProportion']; ?></td>
                <td class="font12"><?php echo $vo['Commission']; ?></td>
                <td class="font12">
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">

                            <a href="<?php echo url('add?ID='.$vo['ID']); ?>" class="layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon">&#xe642;编辑</i></a>
                            <a href="<?php echo url('dellevel?ID='.$vo['ID']); ?>" class="layui-btn layui-btn-primary layui-btn-sm j-tr-del"><i cs="layui-icon">&#xe640;删除</i></a>
                        </div>
                    </div>
                </td>
            </tr>
