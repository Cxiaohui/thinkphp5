...
<div class="layui-form">
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            ...
            <tr>
                <td><input type="checkbox" name="ids[]" class="layui-checkbox checkbox-ids" value="<?php echo $vo['GameID']; ?>" lay-skin="primary"></td>
                <td class="font12">
                    <?php echo $vo['GameID']; ?>
                </td>
                <td class="font12"><?php echo $vo['NickName']; ?></td>
                <td class="font12"><?php echo getUserRoomCard($vo['UserID']); ?></td>
                <td class="font12"><?php echo $vo['AgentID']; ?></td>
                <td class="font12"><?php echo getSpreaderGameID($vo['SpreaderID']); ?></td>
                <td class="font12"><?php echo $vo['RegisterDate']; ?></td>
                <?php if($vo['Nullity'] ==0){ ?>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a  onclick="updataGold(<?php echo $vo['UserID']; ?>)" class="layui-btn layui-btn-primary"><i class="layui-icon">&#xe642;修改金币</i></a>
                            <?php if($vo['AgentID'] ==0){ ?>
                            <a href="javascript:;" class="layui-btn layui-btn-primary "   onclick="confirmUpdateAward(<?php echo $vo['GameID']; ?>,1)"><i class="layui-icon">&#xe640;设置代理</i></a>
                            <?php  } if($vo['Nullity'] ==0){ ?>
                            <a href="javascript:;" class="layui-btn layui-btn-primary "   onclick="setNullity(<?php echo $vo['GameID']; ?>,1)"><i class="layui-icon">&#xe640;封号</i></a>
                            <?php  }else{ ?>
                            <a href="javascript:;" class="layui-btn layui-btn-primary"   onclick="setNullity(<?php echo $vo['GameID']; ?>,0)"><i class="layui-icon">&#xe640;解封</i></a>
                            <?php  } ?>
...
<script>
    ...
    function confirmUpdateAward(gid) {
        layer.confirm('确认设置玩家'+gid+'为代理吗？', {
            ...
            $.ajax({
                url: '<?php echo url("index/api/setUserToAgent"); ?>',
                type:"POST",
                dataType:"json",
                data:{'GameID':gid},
    ...
    function setNullity(gid,type) {
        ...
        layer.confirm(top, {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo url("index/api/setNullity"); ?>',
                async: false,
    ...
    function  updateUserGold() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo url("index/api/updateUserRoomCard"); ?>',
            async: false,
