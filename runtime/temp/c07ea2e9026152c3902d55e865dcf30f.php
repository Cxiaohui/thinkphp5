<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:55:"C:\xampp\htdocs\LotusAdmin/app/admin\view\hook\form.php";i:1534242104;s:52:"C:\xampp\htdocs\LotusAdmin\app\admin\view\layout.php";i:1534242104;s:58:"C:\xampp\htdocs\LotusAdmin\app\admin\view\block\header.php";i:1534242104;s:56:"C:\xampp\htdocs\LotusAdmin\app\admin\view\block\menu.php";i:1534242104;s:57:"C:\xampp\htdocs\LotusAdmin\app\admin\view\block\layui.php";i:1534242104;s:58:"C:\xampp\htdocs\LotusAdmin\app\admin\view\block\footer.php";i:1534242104;}*/ ?>
    ...
    <div class="layui-form-item">
        <div class="layui-input-inline pl50" style="width:500px;">
            <table class="layui-table">
                ...
                <tbody>
                    <?php if(is_array($hook_plugins) || $hook_plugins instanceof \think\Collection || $hook_plugins instanceof \think\Paginator): $i = 0; $__LIST__ = $hook_plugins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $vo['plugins']; ?></td>
                        <td>
                            <input type="text" class="layui-input j-ajax-input fl" style="width:50px;height:25px;" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo $vo['sort']; ?>" data-value="<?php echo $vo['sort']; ?>" data-href="<?php echo url('sort?table=admin_hook_plugins&ids='.$vo['id']); ?>">
                        </td>
                        <td>
                            <input type="checkbox" name="status" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="启用|停用" data-href="<?php echo url('hookPluginsStatus?id='.$vo['id']); ?>">
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
